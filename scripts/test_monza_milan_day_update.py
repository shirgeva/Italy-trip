...
# Day 10 must follow the existing Milan -> hotel -> Monza -> hotel -> Milan flow.
...
# Day 10 itinerary must contain the corrected race names/times and two separate Milan blocks.
...
# Old placeholder wording must remain gone from Day 10.
for stale in [
